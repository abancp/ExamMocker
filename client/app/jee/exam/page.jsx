        ...
        <div className="px-10 flex gap-3">
          <div className="w-[70%]">
            ...
            <div className="h-[23rem] border-b border-black overflow-y-scroll">
              <h1 className="p-3 text-xl font-sans font-semibold"><MathJax>{text}</MathJax></h1>
              <div className="flex flex-col gap-3 p-3 ">
                <label htmlFor="mcq_option_1" className="w-fit cursor-pointer flex gap-3"><input className="cursor-pointer" type="radio" name="mcq_option" id="mcq_option_1" /><h1 className="text-xl font-medium"> (1) <span className="ml-5">3</span></h1></label>
                <label htmlFor="mcq_option_2" className="w-fit cursor-pointer flex gap-3"><input className="cursor-pointer" type="radio" name="mcq_option" id="mcq_option_2" /><h1 className="text-xl font-medium"> (2) <span className="ml-5">1</span></h1></label>
                <label htmlFor="mcq_option_3" className="w-fit cursor-pointer flex gap-3"><input className="cursor-pointer" type="radio" name="mcq_option" id="mcq_option_3" /><h1 className="text-xl font-medium"> (3) <span className="ml-5">2</span></h1></label>
                <label htmlFor="mcq_option_4" className="w-fit cursor-pointer flex gap-3"><input className="cursor-pointer" type="radio" name="mcq_option" id="mcq_option_4" /><h1 className="text-xl font-medium"> (4) <span className="ml-5">6</span></h1></label>
              </div>
            </div>
