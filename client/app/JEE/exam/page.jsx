    ...
    <div className='h-screen  w-full bg-white text-black'>
      ...
      <div className="px-10">
        <div className="w-[70%]">
          ...
          <div className="h-[23rem] overflow-scroll">
            ...
            <div className="flex flex-col gap-3 p-3 ">
              <label htmlFor="mcq_option_1" className="flex gap-1"><input className="cursor-pointer" type="radio" name="mcq_option" id="mcq_option_1" /><h1 className="text-xl font-semibold"> (1) <span className="ml-5">3</span></h1></label>
              <label htmlFor="mcq_option_2" className="flex gap-2"><input className="cursor-pointer" type="radio" name="mcq_option" id="mcq_option_2" /><h1 className="text-xl font-semibold"> (2) <span className="ml-5">1</span></h1></label>
              ...
              <label htmlFor="mcq_option_4" className="flex gap-4"><input className="cursor-pointer" type="radio" name="mcq_option" id="mcq_option_4" /><h1 className="text-xl font-semibold"> (4) <span className="ml-5">6</span></h1></label>
            </div>
            <div className="flex flex-col gap-3 p-3 ">
