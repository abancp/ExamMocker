...
function Login() {
    ...
    return (
        <div className="w-full h-screen justify-center flex pt-40 md:pt-24 p-10 items-center ">
            <Header />
            <div className="w-[450px] md:w-[1000px]  md:flex-row flex-col flex gap-20 py-20 justify-between items-center md:h-[400px] h-[560px] border border-[#259ac4] rounded-lg ">
                ...
                <form onSubmit={handleSubmit} className="md:w-1/2 w-full px-8 flex flex-col items-center justify-center gap-5" action="">
                    ...
                    <input placeholder="Email" className=" p-1 rounded-lg text-lg border border-[#259ac4] focus:outline-none bg-transparent w-full" type="text" />
                    <input placeholder="Password" className=" p-1 rounded-lg text-lg border border-[#259ac4] focus:outline-none bg-transparent w-full" type="password" />
