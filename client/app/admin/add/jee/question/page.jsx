    ...
    return (
        <div className='w-full flex flex-col pt-14 p-4 gap-2 h-screen'>
            ...
            <div className="flex  justify-around w-full items-center">
                ...
                {questionType === "MCQ" && <div id="A" onClick={changeQuestionType} className={`${optionPointing === "A" && "border-b text-[#259ac4]"} px-2 py-1 border-[#259ac4] hover:bg-[#21213b] cursor-pointer`}>Option A <input className='p-1 cursor-pointer' onClick={(e) => { e.stopPropagation() }} type="radio" name='answer' /></div>}
                {questionType === "MCQ" && <div id="B" onClick={changeQuestionType} className={`${optionPointing === "B" && "border-b text-[#259ac4]"} px-2 py-1 border-[#259ac4] hover:bg-[#21213b] cursor-pointer`}>Option B <input className='p-1 cursor-pointer' onClick={(e) => { e.stopPropagation() }} type="radio" name='answer' /></div>}
                {questionType === "MCQ" && <div id="C" onClick={changeQuestionType} className={`${optionPointing === "C" && "border-b text-[#259ac4]"} px-2 py-1 border-[#259ac4] hover:bg-[#21213b] cursor-pointer`}>Option C <input className='p-1 cursor-pointer' onClick={(e) => { e.stopPropagation() }} type="radio" name='answer' /></div>}
                {questionType === "MCQ" && <div id="D" onClick={changeQuestionType} className={`${optionPointing === "D" && "border-b text-[#259ac4]"} px-2 py-1 border-[#259ac4] hover:bg-[#21213b] cursor-pointer`}>Option D <input className='p-1 cursor-pointer' onClick={(e) => { e.stopPropagation() }} type="radio" name='answer' /></div>}
