        ...
        <div className='border border-[#40c425] flex justify-center items-center border-dashed min-h-20 max-h-fit px-3 w-full'>
          {currentQuestion ?
            <div className='w-full py-2 pb-0'>
              ...
              <div className='flex gap-3'><div className='text-lg font-medium'>Q:</div><div className='font-light'>{currentQuestion?.question}</div></div>
        ...
        </div>
        {
          questions?.map((question) => (
            <div href={'/admin/question/' + question._id} className='border-[#259ac4] w-full flex justify-between  p-2 border'>
              <div onClick={() => { setCurrentQuestion(question) }} className="whitespace-nowrap overflow-hidden w-full text-ellipsis">{question.question}</div>
