                ...
                <div className='w-full  h-fit border border-[#259ac4]'>
                    <table className='w-full '>
                        <tbody>
                            ...
                            {
                                exams?.map((exam)=>(
                                    <tr onClick={()=>router.push("/admin/exam/"+exam._id)} className='text-center cursor-pointer  text-lg p-2 border-b border-[#259ac4]'>
                                ...
                                <td className='flex justify-center gap-2 pt-[.35rem]'>
                                    ...
                                    <svg onClick={(e)=>{e.stopPropagation();router.push('/admin/add/jee/question-set/'+exam._id)}}  xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-yellow-400 hover:opacity-60 duration-300 hover:hover:cursor-pointer bi bi-pencil" viewBox="0 0 16 16">
