    ...
    <div className="w-full flex flex-col gap-3 h-fit ">
      ...
      {exams?.map((exam, i) => (
        <Link
          ...
          className={`w-full bg-secondary md:flex cursor-pointer border-primary group  hover:border-[#5cbc20] duration-300 justify-between  items-center rounded-lg border  md:h-12`}
        >
          <div
